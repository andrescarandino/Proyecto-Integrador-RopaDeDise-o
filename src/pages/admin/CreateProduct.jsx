...
import { useCreateProduct, useGetCategories, useToast } from '../../hooks';
					...
					<header className="form-header">
						...
						<div className="form-header-texts-container">
							...
							<p className="section-description">
								Estimado administrador, desde ésta sección
								podrás crear nuevos productos para la
								plataforma.
							</p>
						</div>
					</header>
				...
				contentComponent={
					...
					>
						...
						>
							...
							>
								Escribe a continuación el nuevo valor des esta
								característica.
							</p>
						</header>
						<div className="form-group">
